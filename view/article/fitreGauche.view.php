        ...
        <?php foreach ($checkboxListe as $choix => $valeursChoix): ?>
            <div>
                <button type="button" class="buttonDropFilter" tag="0">
                    ...
                    <svg class="plus" fill="#000000" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg class="minus" fill="#000000" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_iconCarrier">
                            <title>minus</title>
                            <path
