    ...
    <?php include(__DIR__."/header.php"); ?>
        <main class="cmt">
            <div>
                ...
                <p>
                Bienvenue sur Crescendo, vous souhaitez vous débarrasser d'un souvenir encombrant lié au monde de la musique tout en empochant une somme à la hauteur de vos attentes ? Vous avez toqué à la bonne porte. Crescendo vous propose un service fiable et simple d'utilisation.
                </p>
                <br>
                <p>
