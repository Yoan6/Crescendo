        ...
        <main id="faq">
            <div>
                ...
                <p>Cliquez sur l’icône symbolisant votre profil qui est situé en haut à droite. 
                    ...
                    Vous atterrirez alors sur une page où vous aurez la possibilité de modifier 
                    les champs suivants : pseudo, adresse e-mail, adresse de livraison, mot de passe. </p>

                <h3>Au moment de mon inscription, j’ai renseigné un mot de passe dont le format 
                    n’a pas été accepté et je suis bloqué à cette étape, que faire ? </h3>
                <p>Pour des raisons de sécurité et afin de garantir la pérennité de vos données, 
                    nous demandons à nos utilisateurs de renseigner au moins 12 caractères pour le 
