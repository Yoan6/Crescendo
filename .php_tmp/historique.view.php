...
<html lang="fr">
  ...
  <?php include(__DIR__.'/header.php'); ?>
      ...
      <div class="historique-objet">
        <article class="objet">
          <a href=""> <img class="image-article" src="../design/image/article/heart.png"></a>
          <img src="../design/image/article/veste-elton-john.png">
          <div class="infos">
          ...
          <div class="like">
            <a href="" ><img class="image-article" src="../design/image/article/like-white.png"> </a>
            <p>536</p>
            <a href=""><img class="image-article" src="../design/image/article/unlike-white.png"> </a>
          </div>
        </article>
