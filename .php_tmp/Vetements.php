        ...
        <div id="principale">
            <aside class="filtre">
                <div>
                    ...
                    <div id="filterdown">
                        <div>
                            <input type="checkbox" id="Regae" name="Regae" checked>
                            <label>Regae</label>
                        </div>
                        <div>
                        ...
                        <div>
                            <input type="checkbox" id="Rock" name="Rock" checked>
                            <label>Rock</label>
                        </div>
                        <div>
                            <input type="checkbox" id="Metal" name="Metal" checked>
                            <label>Metal</label>
                        </div>
                        <div>
                            <input type="checkbox" id="Rap" name="Rap" checked>
                            <label>Rap</label>
                        </div>
                        <div>
                            <input type="checkbox" id="Regae" name="Regae" checked>
